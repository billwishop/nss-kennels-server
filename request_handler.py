...
from locations import get_all_locations, get_single_location, create_location, delete_location, update_locations
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_PUT(self):
        ...
        # Update a single entry from the list 
        if resource == "animals":
        ...
        # Encode the new entry and send in repsonse
        self.wfile.write("".encode())
